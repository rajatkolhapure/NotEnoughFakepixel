...
public class Configuration extends Config {
    ...
    @Switch(name = "Ashfang waypoints", category = CRIMSON, subcategory = "Ashfang", description = "Put a waypoint on Ashfang for better precision on launching Blazing Souls.")
    public static boolean ashfangWaypoints = true;
